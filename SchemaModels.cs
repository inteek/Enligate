...
namespace sw_EnligateWeb.Models
{
    ...
    public class schemaLigas
    {
        public schemaLigas()
        {
            ligFechaRegistroUTC = DateTime.UtcNow;
            ligEstatus = true;
            ligAprobada = false;
            ligSolicitud = true;
    ...
    public class schemaTarifas
    {
        ...
        {
            tarFechaRegistroUTC = DateTime.UtcNow;
    ...
    public class schemaLigaCanchasTorneos
    {
        ...
        {
            lcatEstatus = true;
            torFechaCreacionUTC = DateTime.UtcNow;
        }
    ...
    public class schemaEquipos
    {
        public schemaEquipos()
        {
            equEstatus = true;
            equPagado = false;
            equFechaCreacionUTC = DateTime.UtcNow;
        }
        ...
        [ForeignKey("equUserIdCreador")]
        public virtual ApplicationUser tblUsuarioCreador { get; set; }
    }
    ...
    public class schemaEquiposCoAdministradores
    {
        ...
        [Key, Required, MaxLength(250), Column(Order = 1)]
    ...
    public class schemaJugadores
    {
        ...
        {
            jugEstatus = true;
            jugFechaCreacionUTC = DateTime.UtcNow;
        }
        [Key, Column(Order = 0),Required]
    ...
    public class schemaArbitros
    {
        ...
        {
            arbEstatus = true;
            arbFechaCreacionUTC = DateTime.UtcNow;
        }
        [Key, Column(Order = 0), Required]
...
//        public virtual schemaArbitros tblArbitros { get; set; }
    ...
    public class schemaPagos
    {
        public schemaPagos()
        {
            pagoFechaCreacionUTC = DateTime.UtcNow;
        }
        [Key, Required]
