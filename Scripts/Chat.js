$(document).ready(function () {
    ...
    $("#btnLogin").click(function () {
        ...
        if (nickName) {
            ...
            var href = "/Admin/ChatEnligate?user=" + encodeURIComponent(nickName);
...
function LoginOnSuccess(result) {
    ...
    $("#btnSpeak").click(function () {
        ...
        if (text) {
            ...
            var href = "/Admin/ChatEnligate?user=" + encodeURIComponent($("#YourNickname").text());
    ...
    $("#btnLogOff").click(function () {
        ...
        document.location.href = "ChatEnligate";
    });
